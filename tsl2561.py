...
#
# modified by Klaus Ruff 4-29-2021 to work with Micropython 1.12 on ESP32

""" TSL2561 driver module
...
Example:
    The TSL2561 driver can be used as follows:
        ...
        tslDev = TSL2561.device(i2c, i2cAddr=0x39)
        tslDev.init()
        lux = tslDev.getLux()
...
# I2C address that is used
TSL2561_I2C_ADDR = 0x29
"""TSL2561 I2C slave addresses
Primary address = 0x29
Secondary address = 0x39
Tertiary address = 0x49
"""
...
class device:
    ...
    def __init__(self, i2c, i2cAddr=TSL2561_I2C_ADDR,
    ...
    def write8(self, register, value):
        ...
        b=bytearray(1)
        b[0]=value & 0xFF
        self.i2c.writeto_mem(self.i2cAddr, register, b)
    ...
    def enable(self):
        if not self.ready:
            return
        try:
            self.write8(TSL2561_REG_CONTROL|TSL2561_CMD, 0x03)
        except OSError:
            print('I2C Error')
            self.error = True
    ...
    def disable(self):
        if not self.ready:
            return
        try:
            self.write8(TSL2561_REG_CONTROL|TSL2561_CMD, 0x00)
        except OSError:
            print('I2C Error')
            self.error = True
    ...
    def applyTiming(self):
        self.enable()
        try:
            self.write8(TSL2561_REG_TIMING|TSL2561_CMD, self.integrationTime + self.gain)
        except OSError:
            print('I2C Error')
            self.error = True
        self.disable()
